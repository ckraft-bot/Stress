...
Get-Process -Name "ConnectIQ" -ErrorAction SilentlyContinue | ForEach-Object {
    Write-Host "Killing simulator PID $($_.Id)..."
...
Start-Sleep -Seconds 5 # give simulator time to start
